...
How does the 'average hepatocyte' compare between the two datasets? For number of genes expressed, say, or the plot of one against the other.

```{r}
zonated = c('Glul', 'Cyp2e1','Cyp2f2','Cps1', 'Rps12', 'Ass1')
table(tissX@meta.data$tissue)
```
