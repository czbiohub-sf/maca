...
pbmc <- StashIdent(object = tiss, save.name = "ClusterNumbers")
...
# SPYROS: how do we show a cluster by plate table?

table(as.character(tiss@meta.data$Annotation), as.character(tiss@meta.data$plate.barcode))
