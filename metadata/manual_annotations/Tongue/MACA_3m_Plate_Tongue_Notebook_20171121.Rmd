...
write.csv(tiss.markers, "gene_markers_2.csv")
```
...
annotation <- c("Basal/differentiating", "Basal/differentiating", "Proliferating", "Maturing/nonkeratinized", "Basal/differentiating", "Stratified/differentiated keratinocytes", "Basal/differentiating", "Filiform" )

tiss@meta.data[,'annotation'] <- plyr::mapvalues(x = tiss@meta.data$cluster.ids, from = cluster.ids, to = annotation)

TSNEPlot(object = tiss, do.label = TRUE, pt.size = 1, label.size = 3, group.by='annotation', do.return = TRUE)
